import {
  delay, takeLatest, call, put, fork,
...
import {
  setPosts, setCommentsById, setUserData, setUserPosts,
} from '../actions/actionCreator';
import {
  ActionSaga, ActionSagaUser, CommentsType, PostsType, UserDataType, UserPostType,
} from '../../types';
...
export function* handleUserPosts({ payload }: ActionSagaUser) {
  try {
    ...
    const userPosts: UserPostType = yield call(getUserPosts, payload);
    yield delay(delayTime);
